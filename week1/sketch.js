...
const quotes = [
  { text: "is a process, based on exploration, iteration, reflection and discovery, \nwhere code is used as the primary medium to create a wide range of media artifacts.", source: "Tim Rodenbröker" },
  ...
  { text: "is a loosely defined term used to describe \na wide range of artistic practices that use computer code as a medium.", source: "Raphael de Courville" },
